            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="https://ui-avatars.com/api/?name={{Auth::user()->name}}" alt="..." class="w-100 border-radius-lg shadow-sm">
    ...
    <div class="container-fluid py-4">
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('user.phone')@enderror">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-0">{{ __('Chanage Password') }}</h6>
                    </div>
                    <div class="card-body pt-4 p-3">
                        <form method="post" action="{{url('change/password')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12 col-sm-12 col-12">
                                    <div class="mb-3">
                                        <label for="emailID" class="form-label">Confirm Password</label>
                                        <input type="password" class="form-control" name="password_confirmation" required>
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-sm-6 col-12 mt-3">
                                    <button class="btn bg-gradient-dark btn-md mb-4">Change Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
