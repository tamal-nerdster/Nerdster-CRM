    ...
    <div class="container-fluid {{ (Request::is('static-sign-up') ? 'container' : 'container-fluid') }}">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item">
                    <a class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}" href="{{ auth()->user() ? url('static-sign-up') : url('register') }}">
                        <i class="fas fa-user-circle opacity-6 me-1 {{ (Request::is('static-sign-up') ? '' : '') }}"></i>
                        Sign Up
                    </a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}" href="{{ auth()->user() ? url('static-sign-in') : url('login') }}">
                        <i class="fas fa-key opacity-6 me-1 {{ (Request::is('static-sign-up') ? '' : '') }}"></i>
                        Sign In
                    </a>
                </li>
            </ul>
