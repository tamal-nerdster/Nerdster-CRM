                ...
                <form role="form text-left" method="post" id="addUserForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Term Months" name="term_months" required>
                            </div>
                        </div>
{{--                          <div class="col-md-6">
                            <label>Monthly price</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Monthly price" name="monthly_price" required step="0.2">
                            </div>
                        </div>
                         <div class="col-md-6">
                            <label>Installation fee</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Installation fee" name="installation_fee" required step="0.2">
                            </div>
                        </div> --}}
                         <div class="col-md-6">
                            <label>Status</label>
                ...
                <form role="form text-left" id="editUserForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Select User</label>
                            <div class="input-group mb-3">
                                <select class="form-control user_id" name="user_id" required id="user_id">
                                    <option value="">Please select</option>
                                    @foreach($users as $user)
                                        <option value="{{$user->id}}">{{$user->name}}</option>
                                    @endforeach
                        ...
                        <div class="col-md-6">
                            <label>Term Months</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Term Months" name="term_months" required id="term_months">
                            </div>
                        </div>
                         <div class="col-md-6">
                            <label>Monthly price</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Monthly price" name="monthly_price" required step="0.2" id="monthly_price">
                            </div>
                        </div>
                         <div class="col-md-6">
                            <label>Installation fee</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="Installation fee" name="installation_fee" required step="0.2" id="installation_fee">
                            </div>
                        </div>
                         <div class="col-md-6">
                            <label>Status</label>
